...
@section('content')
    <div class="form-group">
        <form action="{{ route('albums.store-picture',$album->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header">
                    Add Picture to {{ $album->name }}
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name"  class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                placeholder="Please enter name of picture .. Ex: picture 1" required {{ old('name') }}>
                                @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="album_id" id="album_id" class="form-control" readonly>
